...
right=25mm,
 top=25mm,
bottom=25mm}
\frenchspacing % same space size for everything
...
\hline
\multicolumn{6}{| p{0.9\linewidth} |}{\textbf{Title:} }\\
\hline
...
\hline
\multicolumn{6}{| p{0.9\linewidth} |}{\textbf{Työn nimi:} Three-dimensional magnetotelluric studies on ancient collision zone in Bothnian region}\\
\hline
...
\hline
\multicolumn{6}{| p{0.9\linewidth} |}{\textbf{Tiivistelmä:} \lipsum[1-1] }\\
\hline
